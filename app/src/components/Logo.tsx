  ...
  return (
    <div className="mb-5">
      ...
      <div className="text-black font-serif m-auto my-6 text-center text-2xl max-w-3xl">
        ...
        <br />
        <p>
          Wagers can be made with $ASH (Mortuary Inc utility token) or $SOL in a winner takes nearly
          all battle. Here's the deal: 5% of all winning $ASH bets return to the $ASH pool whereas
          3.5% of all SOL winning bets are redistributed among Legions of Primus holders while 1.5%
          goes to the Mortuary Inc treasury.
        </p>
      </div>
    </div>
  );
